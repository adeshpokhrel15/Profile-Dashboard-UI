...
class childrenhealth extends StatefulWidget {
  static const routeName = "childrenhealth-form";
  @override
  State<childrenhealth> createState() => _childrenhealthState();
}

class _childrenhealthState extends State<childrenhealth> {
  int ind = 0;
  final bloods = [
    'A+',
    'A-',
